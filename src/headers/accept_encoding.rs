...
impl AcceptEncoding {
    ...
    pub(crate) const fn to_header_value(self) -> Option<HeaderValue> {
        Some(match (self.gzip(), self.deflate(), self.br(), self.zstd()) {
            (true, true, true, false) => HeaderValue::from_static("gzip,deflate,br"),
            (true, true, false, false) => HeaderValue::from_static("gzip,deflate"),
            (true, false, true, false) => HeaderValue::from_static("gzip,br"),
            (true, false, false, false) => HeaderValue::from_static("gzip"),
            (false, true, true, false) => HeaderValue::from_static("deflate,br"),
            (false, true, false, false) => HeaderValue::from_static("deflate"),
            (false, false, true, false) => HeaderValue::from_static("br"),
            (true, true, true, true) => HeaderValue::from_static("zstd,gzip,deflate,br"),
            (true, true, false, true) => HeaderValue::from_static("zstd,gzip,deflate"),
            (true, false, true, true) => HeaderValue::from_static("zstd,gzip,br"),
            (true, false, false, true) => HeaderValue::from_static("zstd,gzip"),
            (false, true, true, true) => HeaderValue::from_static("zstd,deflate,br"),
            (false, true, false, true) => HeaderValue::from_static("zstd,deflate"),
            (false, false, true, true) => HeaderValue::from_static("zstd,br"),
            (false, false, false, true) => HeaderValue::from_static("zstd"),
